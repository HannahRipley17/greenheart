                    ...
                    <div class="maincontent">
                        ...
                        <form action="thankyoumobile.php" method="POST" class="applyformgrid">
                            ...
                            <div class="radio">
                                ...
                                <input type="checkbox" name="pets" value="Fish" id="fish">
                                <label for="fish">Fish</label><br>
                                <input type="checkbox" name="pets" value="Birds" id="birds">
                                <label for="birds">Birds</label><br>
                                <input type="checkbox" name="pets" value="Reptiles" id="reptiles">
                                <label for="reptiles">Reptiles</label><br>
                                <input type="checkbox" name="pets" value="None" id="none">
                                <label for="none">None</label><br>
                                <input type="checkbox" name="pets" value="Other" id="other">
